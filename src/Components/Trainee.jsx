...
const Trainee = () => {
  ...
  const staticExams = [
    { title: "Figma Technical Questions", duration: "30 Minutes", date: "march 15, 2025", time: "3:30 PM" },
    { title: "Figma Practical Questions", duration: "1 Day", date: "april 16, 2025", time: "4:00 PM" },
  ];
