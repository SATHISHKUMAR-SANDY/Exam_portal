    ...
    <div className="d-flex">
      <div className="container-fluid">
        <h5 className="mt-3">
          ...
          &gt;
          <Link to="/home/onlinetrainees" className="text-decoration-none text-primary mx-1">
            Online Trainees
          </Link>
          &gt;
          <Link to="/home/offlinetrainees" className="text-decoration-none mx-1 text-black">
            Offline Trainees
          </Link>
        </h5>
